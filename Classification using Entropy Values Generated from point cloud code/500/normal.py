...
entropy_parent_folder = "C:\\Users\\Aneesh PB\\Downloads\\Topology Project\\Full segment\\Entropy code\\500\\Entropy\\Normal cases\\"
...
for image_folder_name in os.listdir(excel_folders_parent_dir):
    ...
    if os.path.isdir(image_folder_path):
        ...
        for excel_file in excel_files:
            ...
            try:
                res = ripser(data_array, n_perm=500, maxdim=1)
            except:
                try:
...
# Parent directory for entropy folders
entropy_parent_folder = "C:\\Users\\Aneesh PB\\Downloads\\Topology Project\\Full segment\\Entropy code\\500\\Entropy\\Bengin cases\\"
i = 0
...
# Parent directory for entropy folders
entropy_parent_folder = "C:\\Users\\Aneesh PB\\Downloads\\Topology Project\\Full segment\\Entropy code\\500\\Entropy\\Malignant cases\\"
i = 0
