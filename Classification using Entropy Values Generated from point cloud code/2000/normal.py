...
entropy_parent_folder = "C:\\Users\\Aneesh PB\\Downloads\\Topology Project\\Full segment\\Entropy code\\2000\\Entropy\\Normal cases\\"
...
for image_folder_name in os.listdir(excel_folders_parent_dir):
    ...
    if os.path.isdir(image_folder_path):
        ...
        for excel_file in excel_files:
            ...
            try:
                res = ripser(data_array, n_perm=2000, maxdim=1)
            except:
                try:
...
# # Parent directory for entropy folders
# entropy_parent_folder = "C:\\Users\\Aneesh PB\\Downloads\\Topology Project\\Full segment\\Entropy code\\2000 points\\Entropy\\Bengin cases\\"
# i = 0
...
#             # Compute persistence diagrams
#             try:
#                 res = ripser(data_array, n_perm=1000, maxdim=1)
#             except:
#                 try:
#                     res = ripser(data_array, maxdim=1)
#                 except:
...
# # Parent directory for entropy folders
# entropy_parent_folder = "C:\\Users\\Aneesh PB\\Downloads\\Topology Project\\Full segment\\Entropy code\\2000 points\\Entropy\\Malignant cases\\"
# i = 0
